...
const AllowBrowserPermissions = () => {
  return (
    <p className="text-sm">
      Please grant your browser permissions to access the camera and microphone.
    </p>
  );
};
...
export const CallLobby = ({ onJoin }: Props) => {
  ...
  const hasBrowerMediaPermissions = hasMicPermission && hasCameraPermission;
